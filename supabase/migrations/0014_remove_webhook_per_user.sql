-- ============================================================================
-- REMOVE WEBHOOK POR USUÁRIO
-- ============================================================================
-- Disparo de cobranças passa a usar URL fixa no front. Só evolution_instancia
-- e evolution_api_key continuam por usuário.
-- ============================================================================

alter table public.profiles drop column if exists evolution_webhook_url;

-- Recria RPC sem o parâmetro p_evolution_webhook_url.
